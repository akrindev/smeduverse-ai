...
const COPILOTKIT_API_URL = import.meta.env.VITE_COPILOTKIT_API_URL || "http://localhost:3000/api/copilotkit";

export default function App() {
	return (
		<CopilotKit runtimeUrl={COPILOTKIT_API_URL}>
			<div className="min-h-screen bg-background text-foreground flex flex-col">
				...
				{/* The AI Widget - CopilotKit Popup */}
				<SmeduverseAIWidget />
			</div>
		</CopilotKit>
	);
