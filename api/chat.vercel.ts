...
/**
 * Vercel Serverless Function for SMEduverse AI Chat API
 * This adapter wraps the Hono app for Vercel's serverless environment
 */
...
// Add CORS middleware - essential for cross-origin requests
app.use("/*", cors());
